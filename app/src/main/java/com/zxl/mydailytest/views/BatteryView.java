...
public class BatteryView extends View {
     ...
     * 电池剩余量百分比 ----
     */
    private float mVolumePercentage = 1f;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mByHeight = mBoardRF.bottom - mBoardRF.top - boardWidth*2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mBatteryVolume.top =
                (int)(mBatteryVolume.bottom - mByHeight * mVolumePercentage - mBoardStrokeWidth);
        // 绘制电池的电量填充 ---
